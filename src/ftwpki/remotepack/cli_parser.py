...
from typing import Callable, Literal, TypeAlias  # noqa: F401
...
class RemotePackCliArguments(PackArguments):
    """
    Class for remote pack command line arguments.
    """
    __slots__ = ["format"]
    helpid = ["remotepack"]
    arg_data = {
        "format": {"flags":["-f", "--format"],
                   "kws":{"choices":["PEM", "DER"],
                          "default": "PEM"},
                    "pre":{}
        },
    ...
    def __init__(self) -> None:
        """
        Initialize the remote pack argument container with default settings.
        """
        super().__init__()
        self.format:Literal["PEM","DER"]="PEM"

RPCli: TypeAlias = RemotePackCliArguments
"""
Type alias for the remote pack command line argument container.
"""

remote_pack_cli_parser = parser_factory_creator(RemotePackCliArguments)
"""
Factory function for creating remote pack command line parsers.

This object is a factory function produced by the parser factory creator 
using the RemotePackCliArguments class.
